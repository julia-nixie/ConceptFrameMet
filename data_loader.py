...
def load_train_data(args, logger, processor, task_name, label_list, tokenizer, output_mode, k=None):
    ...
    if args.model_type in ["MELBERT_MIP", "MELBERT", "FrameMelbert", "SourceLogitsMelbert", "SourceLogitsMelBert_QA", "FrameSourceLogitsMelbert", "MelBertWithQAFrameSource", "MelBertWithQAFrame", "MelBertWithQASource", "MelBertWithSourceConsistency", "SimpleSourceQAMelBert", "SimpleFrameQAMelBert", "HiddenStateSourceQAMelBert", "SoftConfidenceSourceQAMelBert", "AdaptiveSourceQAMelBert"]:
...
def load_dev_data(args, logger, processor, task_name, label_list, tokenizer, output_mode, k=None):
    """Load DEV/validation set for evaluation during training"""
    if task_name == "vua":
        eval_examples = processor.get_dev_examples(args.data_dir)
    elif task_name == "trofi":
        eval_examples = processor.get_dev_examples(args.data_dir, k)
    else:
        raise ("task_name should be 'vua' or 'trofi'!")
    ...
    logger.info("***** Running validation on DEV set *****")
    if args.model_type in ["MELBERT_MIP", "MELBERT", "FrameMelbert", "SourceLogitsMelbert", "SourceLogitsMelBert_QA", "FrameSourceLogitsMelbert", "MelBertWithQAFrameSource", "MelBertWithQAFrame", "MelBertWithQASource", "MelBertWithSourceConsistency", "SimpleSourceQAMelBert", "SimpleFrameQAMelBert", "HiddenStateSourceQAMelBert", "SoftConfidenceSourceQAMelBert", "AdaptiveSourceQAMelBert"]:
    ...
    return all_guids, eval_dataloader, eval_examples
